<script lang="ts">
    ...
    let eventIndex = $page.url.searchParams.has("event")
        ? Object.keys(puzzles).indexOf($page.url.searchParams.get("event"))
        : 0;
...
>
    <div class="filter-bar">
        ...
        {#if !ismbld}
            <div class="label-group">
                ...
                <MultiButton
                    bind:selectedIndex={formatIndex}
                    labels={[
    ...
    <div class="filter-bar">
        <div class="label-group">
            ...
            <MultiButton
                bind:selectedIndex={eventIndex}
                padding={4}
                fixedHeight={false}
                labels={Object.values(puzzles).map((p) => ({
