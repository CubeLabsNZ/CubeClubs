...
<DetailPage heading="Manage Meetups" top={64}>
    ...
    <!-- TODO: THIS IS HEAVILY DUPLICATED CODE FROM MEETUPS.. EXTEND TO COMPONENT? -->
...
<style>
    /* TODO: AGAIN ALL OF THIS CODE IS COPY PASTED FROM MEETUPS... MAYBE EXTEND TO A SHARED CSS FILE... */
    button {
        padding: 0;
        margin: 0;
